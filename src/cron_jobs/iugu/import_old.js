...
(async () => {
  ...
  console.log (' ====== BEGIN Import OLD IUGU')

  try{
    
    const import_result = await importer.importAllSince(7);
    console.log('IUGU:IMPORTER::OLD:', (import_result||[]).length);
  ...
  console.log (' ====== END Import OLD IUGU')
