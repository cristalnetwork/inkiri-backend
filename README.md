...
2. Configuring parameters 
  ...
  * DDBB parmeters,
  * Google Drive Storage parmeters -_optional_-,
  * Payment Gateway parameters [https://iugu.com](https://iugu.com/) -_optional_-,
  * Firebase Push Notification service -_optional_-,
  * Configure cron jobs.
